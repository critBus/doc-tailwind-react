const EjemploPrimeraLineaTexto = () => {
  return (
    <div className="m-3 flex flex-col w-full">
      ...
      <p>
        Se puede modificar el estilo de la primera linea de un parrafo con
        first-line:propiedad
      </p>
      ...
      <p>
        Se puede modificar el estilo de la primera letra de un parrafo con
        first-letter:propiedad
      </p>
      <div className="flex mt-2 border-2 border-red-500 rounded-xl flex-col items-center">
        ...
        <p
          className="first-letter:text-7xl first-letter:font-bold first-letter:mr-3
        ...
        >
          ...
          nesciunt laudantium ducimus! Quam eligendi perferendis ex veritatis
          tenetur quae recusandae. Magnam eum laboriosam aspernatur quidem
          necessitatibus labore consequatur a magni!. Lorem ipsum dolor sit amet
          consectetur adipisicing elit. Soluta, laborum enim voluptatem suscipit
          voluptatibus eius ea autem magnam magni excepturi porro labore eos
          debitis eaque, dolores impedit quod deleniti. Reprehenderit?
        </p>
      </div>
    </div>
  );
